...
/**
 * Main Page Component
 * Fetches specialist data and renders with Builder.io integration
 */
...
export default async function TradespersonProfilePage({
  ...
  return (
    <Suspense fallback={<TradespersonLoader />}>
      <>
        {/* Option 1: Use Builder.io Visual Template */}
        <div className="hidden">
          {/* Uncomment when Builder.io model is ready */}
          {/* <BuilderTranslator
        ...
        {/* Option 2: Use the legacy React component with injected data */}
