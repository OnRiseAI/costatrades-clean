...
const popularSearches = [
  ...
  { label: "House Cleaning Services Marbella", href: "/locations/marbella-area/marbella/cleaning-services" },
  { label: "Removals Company Costa del Sol", href: "/locations/marbella-area/marbella/removals" },
  { label: "Home Security Systems Estepona", href: "/locations/estepona-manilva/estepona-town/security-alarms" },
  { label: "Pest Control Services Fuengirola", href: "/locations/fuengirola-area/fuengirola-town/pest-control" },
];
...
const findTradespeople = [
  ...
  { label: "Cleaning Services Near Me", href: "/post-job?option=Cleaning" },
  { label: "Removals Company Near Me", href: "/post-job?option=Removals" },
  { label: "Security Alarm Installation Near Me", href: "/post-job?option=Security" },
  { label: "Pest Control Near Me", href: "/post-job?option=Pest%20Control" },
];
...
const costGuides = [
  ...
  { label: "Cleaning Services Rates Spain", href: "/cost-guides/cleaning-services" },
  { label: "House Removal Costs Costa del Sol", href: "/cost-guides/removals" },
  { label: "Home Security System Prices 2025", href: "/cost-guides/security-alarms" },
  { label: "Pest Control Treatment Costs", href: "/cost-guides/pest-control" },
];
