...
export default function TradespersonProfile({
  ...
  return (
    <div className="min-h-screen bg-[#F3F4F6] font-sans pb-20 md:pb-0" itemScope itemType="https://schema.org/LocalBusiness">
      {/* Hidden Schema.org metadata for search engines */}
      <meta itemProp="name" content={safeProfile.businessName} />
      <meta itemProp="description" content={safeProfile.bio} />
      <meta itemProp="telephone" content={safeProfile.phone || ""} />
      <meta itemProp="url" content={safeProfile.website || ""} />
      {safeProfile.address && <meta itemProp="address" content={`${safeProfile.address}, ${safeProfile.location}, Costa del Sol, Spain`} />}
      {safeProfile.rating && <meta itemProp="aggregateRating" content={String(safeProfile.rating)} />}
      <link itemProp="image" href={safeProfile.profilePhoto || safeProfile.coverImage} />

      <SEO
        title={`${safeProfile.businessName || "Business"} - ${safeProfile.tradeCategory} in ${safeProfile.location || "Costa del Sol"} | CostaTrades`}
        description={`Hire ${safeProfile.businessName || "this business"}, a verified ${safeProfile.tradeCategory || "tradesperson"} in ${safeProfile.location || "Costa del Sol"}. ${safeProfile.rating ? `Rating: ${safeProfile.rating}★` : ""} Get free quotes today.`}
      />
          ...
          <div className="flex-1 pb-2 sm:mt-[60px] pt-3">
            ...
            <div className="flex flex-wrap items-center gap-4 mt-3">
              ...
              <a
                ...
                className="inline-flex items-center gap-3 px-4 py-1.5 bg-white border border-gray-200 rounded-full shadow-sm hover:border-[#0066CC] transition-colors cursor-pointer"
              >
              ...
              {/* Claim This Profile Button - Only show for unclaimed listings */}
              {!safeProfile.isClaimed && (
                <Link
                  href={`/tradesperson-details?claim=${safeProfile.slug}`}
                  className="inline-flex items-center gap-2 px-4 py-1.5 bg-[#FF8A00] hover:bg-[#e67c00] text-white text-sm font-bold rounded-full shadow-sm transition-colors"
                >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[66%_33%] gap-8">
          ...
          <div className="space-y-10">
            ...
            <article className="bg-white border border-gray-200 rounded-lg shadow-sm p-8">
              ...
              {/* AEO-friendly summary for answer engines */}
              <div className="mt-6 p-4 bg-slate-50 rounded-lg border border-slate-100">
                <p className="text-sm text-gray-700">
                  <strong className="text-[#0a1f44]">{safeProfile.businessName}</strong> is a professional {safeProfile.tradeCategory.toLowerCase()}
                  serving {safeProfile.location} and surrounding areas on the Costa del Sol.
                  {safeProfile.yearsInBusiness > 0 && ` With ${safeProfile.yearsInBusiness} years of experience,`}
                  {safeProfile.verified && " this verified business"} offers services including {services.slice(0, 3).join(", ").toLowerCase()}, and more.
                </p>
              </div>
            </article>
            ...
            {/* RATES & PRICING GUIDE - AEO Optimized Section */}
            <section itemScope itemType="https://schema.org/Service" className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
              {/* Section Header with Location Context */}
              <div className="bg-gradient-to-r from-slate-50 to-white px-6 py-6 border-b border-gray-200">
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                  <div>
                    <h2 className="text-[#0a1f44] font-bold text-xl mb-2" itemProp="name">
                      Rates & Pricing Guide for {safeProfile.tradeCategory} in {safeProfile.location}
                    </h2>
                    <p className="text-sm text-gray-600 max-w-xl">
                      Average costs for {safeProfile.tradeCategory.toLowerCase()} services on the Costa del Sol.
                      Prices may vary based on job complexity, materials, and access requirements.
                    </p>
                  </div>
                  <Link
                    href="/cost-guides"
                    className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg bg-green-50 text-[#16A34A] text-sm font-bold border border-green-100 whitespace-nowrap self-start hover:bg-green-100 transition-colors"
                  >
              ...
              {/* Pricing Table - Structured for AEO */}
              <div itemProp="offers" itemScope itemType="https://schema.org/AggregateOffer">
                <meta itemProp="priceCurrency" content="EUR" />

                {/* Call Out Fee */}
                <div className="flex flex-row justify-between items-center px-6 py-5 border-b border-gray-100 hover:bg-slate-50/50 transition-colors">
                  <div>
                    <div className="font-semibold text-[#0a1f44]">Call Out Fee</div>
                    <p className="text-xs text-gray-500 mt-0.5">Initial visit and assessment</p>
                  </div>
                  <div className="text-right">
                    <div className="font-bold text-[#0a1f44] text-lg" itemProp="lowPrice">
                      {pricing.callOut}
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-row justify-between items-center px-6 py-5 border-b border-gray-100 hover:bg-slate-50/50 transition-colors">
                  <div>
                    <div className="font-semibold text-[#0a1f44]">Daily Labour Rate</div>
                    <p className="text-xs text-gray-500 mt-0.5">Standard working day (8 hours)</p>
                  </div>
                  <div className="text-right">
                ...
                <div className="flex flex-row justify-between items-center px-6 py-5 border-b border-gray-100 hover:bg-slate-50/50 transition-colors">
                  <div>
                    <div className="font-semibold text-[#0a1f44]">{pricing.commonJob.name}</div>
                    <p className="text-xs text-gray-500 mt-0.5">Typical project cost (materials included)</p>
                  </div>
                  <div className="text-right">
                    <div className="font-bold text-[#0a1f44] text-lg" itemProp="highPrice">
              ...
              {/* AEO Answer Block - Direct answer format for voice/AI search */}
              <div className="px-6 py-5 bg-blue-50/50 border-t border-blue-100">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-700 leading-relaxed">
                      <strong className="text-[#0a1f44]">How much does a {safeProfile.tradeCategory.toLowerCase()} cost in {safeProfile.location}?</strong>
                      <br />
                      On average, {safeProfile.tradeCategory.toLowerCase()}s in {safeProfile.location} charge {pricing.callOut} for a call out,
                      with daily rates ranging from {pricing.dayRate}. A typical {pricing.commonJob.name.toLowerCase()} costs {pricing.commonJob.price}.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="px-6 py-4 bg-white border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-3">
                <p className="text-sm text-gray-500">
                  Prices are estimates. Request a detailed quote for your specific job.
                </p>
                <Link
                  href={`/post-job?category=${safeProfile.tradeCategorySlug}&area=${(safeProfile.location).toLowerCase().replace(/\s+/g, "-")}`}
                  className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#FF8A00] hover:bg-[#e67c00] text-white font-bold text-sm rounded-lg transition-colors shadow-sm"
                >
                  Get Your Free Quote
            ...
            {/* CONTEXTUAL CLAIM BANNER - Shows for unclaimed listings */}
            {!safeProfile.isClaimed && (
              <div className="bg-gradient-to-r from-[#0a1f44] to-[#1a3a6c] rounded-xl p-6 shadow-lg">
                <div className="flex flex-col md:flex-row items-center gap-6">
                  <div className="w-16 h-16 bg-white/10 rounded-full flex items-center justify-center flex-shrink-0">
                    <Flag className="w-8 h-8 text-[#FF8A00]" />
                  </div>
                  <div className="flex-1 text-center md:text-left">
                    <h3 className="text-white font-bold text-lg mb-1">
                      Business Owner? Update These Prices
                    </h3>
                    <p className="text-blue-200 text-sm">
                      Claim your listing to display your actual rates, respond to enquiries, and receive job leads.
                    </p>
                  </div>
                  <Link href={`/claim-business?slug=${safeProfile.slug}`}>
                    <Button className="bg-[#FF8A00] hover:bg-[#e67c00] text-white font-bold px-6 py-3 rounded-lg whitespace-nowrap shadow-md">
                      Claim & Update Prices
                    </Button>
                  </Link>
                </div>
            ...
            <section className="bg-[#F9FAFB] rounded-xl p-8 border border-gray-100">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 gap-4">
                ...
                {safeProfile.googleReviews?.reviews && safeProfile.googleReviews.reviews.length > 0 && (
                  <div className="flex items-center gap-2">
                    <span className="text-sm text-gray-500">
                      {safeProfile.googleReviews.reviews.length} reviews
                    </span>
                    <a
                      href={safeProfile.googleMapsUrl || "#"}
                      target="_blank"
              ...
              {safeProfile.googleReviews?.reviews && safeProfile.googleReviews.reviews.length > 0 ? (
                <>
                  {/* Reviews Grid - shows 5 reviews + 1 CTA card per page (2 rows of 3) */}
                  {(() => {
                    const reviews = safeProfile.googleReviews.reviews;
                    const reviewsPerPage = 5; // 5 reviews + 1 CTA card = 6 items (2 rows of 3)
                      ...
                      <>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            ...
                            <div key={i} className="bg-white border border-gray-200 rounded-lg p-5 shadow-sm hover:shadow-md transition-shadow">
                              <div className="flex items-start justify-between mb-3">
                                <div className="flex items-center gap-3">
                                  ...
                                  <div>
                                    <div className="font-bold text-[#0a1f44] text-sm">
                                      {review.reviewer_name || "Anonymous"}
                                    </div>
                                    <div className="text-xs text-gray-400">
                                      {review.published_at ? new Date(review.published_at).toLocaleDateString('en-GB', { day: 'numeric', month: 'short', year: 'numeric' }) : ""}
                                    </div>
                                  </div>
                                </div>
                              </div>
                              ...
                              {review.response_from_owner && (
                                <div className="bg-[#EFF6FF] rounded-md p-2 mt-3">
                                  <p className="text-xs text-blue-800 line-clamp-2">
                                    <span className="font-bold">Response:</span> {review.response_from_owner}
                                  </p>
                                </div>
                              )}
                            </div>
                          ...
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="bg-gradient-to-br from-[#0a1f44] to-[#1a3a6c] border border-gray-200 rounded-lg p-5 shadow-sm hover:shadow-lg transition-all flex flex-col items-center justify-center text-center min-h-[200px] group"
                          >
                            <div className="w-14 h-14 bg-white/10 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                              <Star className="w-7 h-7 text-[#FFB400]" />
                            </div>
                            ...
                            <span className="inline-flex items-center gap-2 px-4 py-2 bg-white text-[#0a1f44] font-bold rounded-lg text-sm group-hover:bg-gray-100 transition-colors">
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24"
                                width="16"
                              ...
                              >
                                ...
                                <path fill="#34A853" d="M12.255 24c3.24 0 5.95-1.08 7.92-2.91l-3.86-3c-1.08.72-2.45 1.16-4.06 1.16-3.13 0-5.78-2.11-6.73-4.96h-3.98v3.09C3.515 21.3 7.565 24 12.255 24z"/>
                                <path fill="#FBBC05" d="M5.525 14.29c-.25-.72-.38-1.49-.38-2.29s.14-1.57.38-2.29v-3.09h-3.98C.435 8.55 0 10.37 0 12.29c0 1.92.435 3.74 1.545 5.71l3.98-3.09z"/>
                                <path fill="#EA4335" d="M12.255 4.58c1.77 0 3.35.61 4.6 1.8l3.42-3.42C18.205 1.19 15.495 0 12.255 0c-4.69 0-8.74 2.7-10.71 6.62l3.98 3.09c.95-2.85 3.6-4.96 6.73-4.96z"/>
                              </svg>
                              Write on Google
                            </span>
                          </a>
                        ...
                        {/* Pagination Controls - Show when multiple pages exist */}
                        {totalPages > 1 && (
            ...
            {/* FAQ SECTION - Collapsible Accordion with Schema.org markup */}
            <section itemScope itemType="https://schema.org/FAQPage" className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
              <div className="px-6 py-5 border-b border-gray-200 bg-slate-50">
                <h2 className="text-[#0a1f44] font-bold text-xl">
                  Frequently Asked Questions
                </h2>
                <p className="text-sm text-gray-500 mt-1">
                  Common questions about hiring a {safeProfile.tradeCategory.toLowerCase()} in {safeProfile.location}
                </p>
              </div>
              ...
              <div className="divide-y divide-gray-100">
                ...
                <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
                  ...
                  >
                    <h3 itemProp="name" className="font-semibold text-[#0a1f44] pr-4">
                      How much does a {safeProfile.tradeCategory.toLowerCase()} charge in {safeProfile.location}?
                    </h3>
                    <ChevronRight className={`w-5 h-5 text-gray-400 flex-shrink-0 transition-transform ${faqOpen === 0 ? 'rotate-90' : ''}`} />
                  </button>
                  <div
                    itemScope
                    itemProp="acceptedAnswer"
                    itemType="https://schema.org/Answer"
                    className={`overflow-hidden transition-all duration-300 ${faqOpen === 0 ? 'max-h-40 pb-4' : 'max-h-0'}`}
                  >
                    <p itemProp="text" className="text-gray-600 text-sm leading-relaxed px-6">
                      {safeProfile.tradeCategory}s in {safeProfile.location} typically charge {pricing.callOut} for a call out fee,
                      with daily rates of {pricing.dayRate}. For a {pricing.commonJob.name.toLowerCase()},
                      expect to pay {pricing.commonJob.price}. Prices vary based on job complexity and materials required.
                    </p>
                  </div>
                </div>

                {/* FAQ Item 2 - Languages */}
                <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
                  <button
                  ...
                  >
                    <h3 itemProp="name" className="font-semibold text-[#0a1f44] pr-4">
                      Do {safeProfile.tradeCategory.toLowerCase()}s in {safeProfile.location} speak English?
                    </h3>
                    <ChevronRight className={`w-5 h-5 text-gray-400 flex-shrink-0 transition-transform ${faqOpen === 1 ? 'rotate-90' : ''}`} />
                  </button>
                  <div
                    itemScope
                    itemProp="acceptedAnswer"
                    itemType="https://schema.org/Answer"
                    className={`overflow-hidden transition-all duration-300 ${faqOpen === 1 ? 'max-h-40 pb-4' : 'max-h-0'}`}
                  >
                    <p itemProp="text" className="text-gray-600 text-sm leading-relaxed px-6">
                      Many {safeProfile.tradeCategory.toLowerCase()}s on the Costa del Sol speak English, German, and Spanish.
                      CostaTrades features verified professionals who can communicate in your preferred language,
                      making it easy to discuss your requirements and receive accurate quotes.
                    </p>
                  </div>
                </div>
                ...
                <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
                  ...
                  >
                    <h3 itemProp="name" className="font-semibold text-[#0a1f44] pr-4">
                      How do I find a reliable {safeProfile.tradeCategory.toLowerCase()} in {safeProfile.location}?
                    </h3>
                    <ChevronRight className={`w-5 h-5 text-gray-400 flex-shrink-0 transition-transform ${faqOpen === 2 ? 'rotate-90' : ''}`} />
                  </button>
                  <div
                    itemScope
                    itemProp="acceptedAnswer"
                    itemType="https://schema.org/Answer"
                    className={`overflow-hidden transition-all duration-300 ${faqOpen === 2 ? 'max-h-48 pb-4' : 'max-h-0'}`}
                  >
                    <p itemProp="text" className="text-gray-600 text-sm leading-relaxed px-6">
                      Look for verified professionals with Google reviews, check their portfolio of completed work,
                      and request multiple quotes. CostaTrades verifies contact details and displays authentic customer reviews
                      to help you make an informed decision. Request proof of insurance before work begins.
                    </p>
                  </div>
                </div>

                {/* FAQ Item 4 - Availability */}
                <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
                  <button
                  ...
                  >
                    <h3 itemProp="name" className="font-semibold text-[#0a1f44] pr-4">
                      Can I get a free quote from {safeProfile.businessName}?
                    </h3>
                    <ChevronRight className={`w-5 h-5 text-gray-400 flex-shrink-0 transition-transform ${faqOpen === 3 ? 'rotate-90' : ''}`} />
                  </button>
                  <div
                    itemScope
                    itemProp="acceptedAnswer"
                    itemType="https://schema.org/Answer"
                    className={`overflow-hidden transition-all duration-300 ${faqOpen === 3 ? 'max-h-40 pb-4' : 'max-h-0'}`}
                  >
                    <p itemProp="text" className="text-gray-600 text-sm leading-relaxed px-6">
                      Yes, you can request a free, no-obligation quote through CostaTrades. Simply click
                      &quot;Request a Quote&quot; and describe your job requirements. Most professionals respond within 24 hours
                      with a detailed estimate for your specific project.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="px-6 py-4 bg-slate-50 border-t border-gray-100 text-center">
                <p className="text-sm text-gray-600">
                  Have more questions?{" "}
                  <Link href="/contact" className="text-[#0066CC] font-semibold hover:underline">
          ...
          <div className="relative">
            <div className="sticky top-[100px] space-y-6">
              ...
              <div className="bg-gradient-to-b from-white to-slate-50 border border-gray-200 rounded-2xl shadow-lg overflow-hidden">
                {/* Header with gradient accent */}
                <div className="bg-gradient-to-r from-[#0a1f44] to-[#1a3a6c] px-6 py-4">
                ...
                <div className="p-6">
                  {/* Availability Status */}
                  <div className="flex items-center justify-between mb-6 p-3 bg-green-50 border border-green-100 rounded-xl">
                    <div className="flex items-center gap-3">
                      <div className="relative">
                        <div className="w-3 h-3 rounded-full bg-[#16A34A]"></div>
                        <div className="absolute inset-0 w-3 h-3 rounded-full bg-[#16A34A] animate-ping opacity-75"></div>
                      </div>
                  ...
                  <div className="space-y-3">
                    <Link
                      ...
                      className="block"
                    >
                      <Button className="w-full bg-gradient-to-r from-[#0066CC] to-[#0052A3] hover:from-[#0052A3] hover:to-[#003d7a] text-white font-bold h-14 text-base shadow-md hover:shadow-lg transition-all rounded-xl flex items-center justify-center gap-2">
                    ...
                    <a
                      href={`https://wa.me/${safeProfile.phone?.replace(/[^0-9]/g, "")}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="block"
                    >
                      <Button className="w-full bg-gradient-to-r from-[#25D366] to-[#128C7E] hover:from-[#1ebc57] hover:to-[#0d7a6d] text-white font-bold h-14 text-base shadow-md hover:shadow-lg transition-all rounded-xl flex items-center justify-center gap-2">
                    ...
                    <a
                      href={safeProfile.phone ? `tel:${safeProfile.phone}` : "#"}
                      className="block"
                      onClick={(e) => !safeProfile.phone && e.preventDefault()}
                    >
                      <button
                        className="w-full border-2 border-gray-200 hover:border-[#0a1f44] hover:bg-slate-100 text-[#0a1f44] font-semibold h-12 text-sm rounded-xl flex items-center justify-center gap-2 transition-all bg-white"
                      >
                        <Phone className="w-4 h-4" />
                        {safeProfile.phone ? "Call Directly" : "Phone on Request"}
                      </button>
                    </a>
                  </div>
                ...
                <div className="bg-slate-50 px-6 py-3 border-t border-gray-100">
                  <p className="text-xs text-gray-500 flex items-center justify-center gap-1.5">
                    ...
                    <span>Protected by <strong className="text-[#0a1f44]">CostaTrades Guarantee</strong></span>
                  </p>
                </div>
              </div>

              {/* CLAIM BUSINESS CARD - Enhanced Conversion Design */}
              {!safeProfile.isClaimed && (
                <div className="bg-gradient-to-br from-[#FFF7ED] to-[#FFEDD5] border-2 border-[#FF8A00] rounded-xl overflow-hidden shadow-md">
                  {/* Header Badge */}
                  <div className="bg-[#FF8A00] px-4 py-2 flex items-center justify-center gap-2">
                    <AlertTriangle className="w-4 h-4 text-white" />
                    <span className="text-white text-sm font-bold">Unclaimed Listing</span>
                  </div>
                  ...
                  <div className="p-5">
                    ...
                    <p className="text-sm text-gray-600 mb-4">
                      Take control of your profile and start receiving qualified leads from customers in {safeProfile.location}.
                    </p>
                    ...
                    <ul className="space-y-2 mb-5">
                      <li className="flex items-center gap-2 text-sm text-gray-700">
                        ...
                        <span>Respond to reviews & enquiries</span>
                      </li>
                      <li className="flex items-center gap-2 text-sm text-gray-700">
                        <CheckCircle className="w-4 h-4 text-[#16A34A] flex-shrink-0" />
                        <span>Update photos & business info</span>
                      </li>
                      <li className="flex items-center gap-2 text-sm text-gray-700">
                        <CheckCircle className="w-4 h-4 text-[#16A34A] flex-shrink-0" />
                        <span>Get verified badge & priority ranking</span>
                      </li>
                    </ul>

                    <Link href={`/claim-business?slug=${safeProfile.slug}`}>
                      <Button className="w-full bg-[#FF8A00] hover:bg-[#e67c00] text-white font-bold h-12 text-base shadow-sm rounded-lg">
              ...
              {/* Smaller "Is this your business?" prompt for claimed listings */}
              {safeProfile.isClaimed && (
                <div className="bg-[#FFF7ED] border border-[#FF8A00] rounded-lg p-4 shadow-sm">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-[#FF8A00]/10 rounded-full flex items-center justify-center flex-shrink-0">
                      <Building2 className="w-5 h-5 text-[#FF8A00]" />
                    </div>
                    <div className="flex-1">
                      <h3 className="text-sm font-bold text-[#0a1f44]">
                        Own a similar business?
                      </h3>
                      <p className="text-xs text-gray-600">
                        Get listed and receive leads
                      </p>
                    </div>
                    <Link href="/list-your-business">
                      <Button size="sm" className="bg-[#FF8A00] hover:bg-[#e67c00] text-white font-bold text-xs px-3">
                        List Free
                      </Button>
                    </Link>
                  </div>
