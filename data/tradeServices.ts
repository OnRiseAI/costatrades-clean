...
export const tradeServices: TradeServices = {
  ...
  "pest-control": {
    title: "What pest control services do you need?",
    services: [
      {
        id: "insects",
        label: "Insect control",
        description: "e.g. cockroaches, ants, flies, mosquitoes",
      },
      {
        id: "rodents",
        label: "Rodent control",
        description: "e.g. rats, mice",
      },
      {
        id: "wasps",
        label: "Wasp & bee nest removal",
        description: "e.g. wasp nests, bee hives",
      },
      {
        id: "termites",
        label: "Termite inspection & treatment",
        description: "e.g. wood damage, prevention",
      },
      {
        id: "bedbugs",
        label: "Bed bug treatment",
        description: "e.g. mattress, furniture",
      },
      {
        id: "prevention",
        label: "Preventive treatment",
        description: "e.g. annual contracts, regular spraying",
      },
      {
        id: "commercial",
        label: "Commercial pest control",
        description: "e.g. restaurants, hotels, offices",
      },
      {
        id: "other",
        label: "Other/I'm not sure",
  ...
  removals: {
    title: "What removal services do you need?",
    services: [
      {
        id: "local",
        label: "Local house move",
        description: "e.g. within Costa del Sol",
      },
      {
        id: "national",
        label: "National move",
        description: "e.g. within Spain",
      },
      {
        id: "international",
        label: "International move",
        description: "e.g. UK to Spain, Europe",
      },
      {
        id: "single-item",
        label: "Single item delivery",
        description: "e.g. furniture, appliances",
      },
      {
        id: "man-van",
        label: "Man & van service",
        description: "e.g. small loads, hourly hire",
      },
      {
        id: "packing",
        label: "Packing services",
        description: "e.g. professional packing, materials",
      },
      {
        id: "storage",
        label: "Storage solutions",
        description: "e.g. short/long term storage",
      },
      {
        id: "other",
        label: "Other/I'm not sure",
  ...
  "security-alarms": {
    title: "What security services do you need?",
    services: [
      {
        id: "alarm-install",
        label: "Alarm system installation",
        description: "e.g. new alarm system",
      },
      {
        id: "cctv",
        label: "CCTV installation",
        description: "e.g. cameras, recording systems",
      },
      {
        id: "repair",
        label: "Alarm repair & maintenance",
        description: "e.g. faults, servicing",
      },
      {
        id: "monitoring",
        label: "Alarm monitoring setup",
        description: "e.g. 24/7 monitoring service",
      },
      {
        id: "video-doorbell",
        label: "Video doorbell installation",
        description: "e.g. Ring, Eufy, smart doorbells",
      },
      {
        id: "smart-locks",
        label: "Smart lock installation",
        description: "e.g. keyless entry, app-controlled",
      },
      {
        id: "upgrade",
        label: "Security system upgrade",
        description: "e.g. newer technology, expansion",
      },
      {
        id: "other",
        label: "Other/I'm not sure",
